...
const getListingsData = ()=> {
    $.ajax({
        ...
        success: (data)=> {
            ...
            $(`#listingList`).empty();
            data.map((listing)=> {
                let listingCard = `<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 mt-3">`;
                listingCard += `<div class="card h-100 border-secondary" >`;
                ...
                listingCard += `<div class="btn btn-primary">View</div>`;
                listingCard += `</div>`;
